            ...
            <header className=" bg-gray-200 fixed top-0 left-0 w-full z-50 ">
                <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <button  onClick={()=> navigate ('./Dashboard')} className="md:flex md:items-center md:gap-12">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="block md:hidden">
                                <button onClick={change} className="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75">
                                    <svg
